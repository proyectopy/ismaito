<x-filament-widgets::widget class="fi-filament-info-widget">
    <x-filament::section>
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                <a
                    href="https://proyectopy.es"
                    rel="noopener noreferrer"
                    target="_blank"
                >
                <img class="pull-right" src="/images/proyectopi_logo.png" alt="Girl in a jacket" width="149" height="51">
            ...
            <div class="flex flex-col items-end gap-y-1">
                <x-filament::link
                    color="gray"
                    href="https://proyectopy.es/tutoriales"
                ...
                <x-filament::link
                    color="gray"
                    href="https://github.com/proyectopy"
